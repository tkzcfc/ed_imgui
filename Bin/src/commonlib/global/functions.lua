        ...
        for k, v in pairs(lua_table) do
			if not excludeKeys[k] then    
                ...
                if type(v) == "table" then
                    table_insert(lines, szPrefix .. "[" .. tostring(k) .. "] = {")
                    ...
                    table_insert(lines, szPrefix.."[" .. tostring(k) .. "] = " .. szValue .. ",")
                end
            end
        end
    end
...
local function ImVec4(_x, _y, _z, _w)
